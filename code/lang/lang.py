def lang(myLanguage):
    ...
    if myLanguage == 'en':
        ...
        bonus_money, bonus_prestige = ['image$.jpg', 'imagePP.jpg']
    else:
    ...
    return [assoc_1, assoc_2, continue_last, bonus_cant_already, lotery_free, lotery_bonus, bonus_you, video_present, secure_bonus, skip_buy_ticket, bonus_money, bonus_prestige]
